...
import '../../css/blockInterest/BlockInterest02.css';
...
class BlockInterest02 extends React.Component {
  componentDidMount() {
        ...
        if (int.title === value) {
          return (
            <div key={int.title} className="col m4 s6">
              <div className="card-interest02">
                <div className="box-img-interest">
...
export default connect(mapStateToProps, actions)(BlockInterest02);
